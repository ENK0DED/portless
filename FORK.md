...
Rechecked against upstream on 2026-06-18: GitHub reported 48 open PRs, and every open PR is listed below with a fork state. The WebSocket-over-HTTP/2 PR remains deliberately deferred; every other open PR is implemented, implemented differently, or won't implement.
