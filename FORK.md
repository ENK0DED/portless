...
- #333 was reassessed on 2026-06-18 and is not UI-focused. It is planned CLI/process-supervision work. The implementation plan lives in `docs/superpowers/plans/2026-06-18-upstream-pr-333-bg-management.md`.
- #264, #240, and #212 are UI-focused deferred work. Route them to an agent that is strong at browser UX, frontend behavior, and visual/security tradeoffs.

### Planned CLI/Process Work

| Upstream PR                                                                            | Plan                                                                 | Notes                                                                                                                                                                                                                                                                                                     |
| -------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [#333 Add background app management](https://github.com/vercel-labs/portless/pull/333) | `docs/superpowers/plans/2026-06-18-upstream-pr-333-bg-management.md` | Planned. This is first-party `portless bg` process supervision for agent workflows, not UI work. The fork should implement it differently from upstream: locked registry, private logs, ready-file handshake instead of stdout scraping, exact route cleanup, and no arbitrary same-port process killing. |
...
| ---------------------------------------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [#333 Add background app management](https://github.com/vercel-labs/portless/pull/333)               | planned                 | Not UI-focused. First-party `portless bg` is useful for agent workflows, but it must be implemented with fork-specific CLI lifecycle design: locked state, private logs, readiness handshake, exact route cleanup, and no arbitrary same-port process killing. Plan: `docs/superpowers/plans/2026-06-18-upstream-pr-333-bg-management.md`. |
